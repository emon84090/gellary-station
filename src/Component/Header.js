                    ...
                    <div className="header-all-content flex-wrap flex justify-between items-center">
                        ...
                        <div className="header-link flex">
                            <div className="signup-btn ">
                                <button className='bg-gray-900 w-20 h-10 text-white rounded-xl'><Link className='h-full font-semibold justify-center flex items-center' to="/registration">Sign Up</Link></button>
                            </div>
                            <div className="login-btn ml-3">
                                <button className='bg-gray-900 w-20 h-10 text-white rounded-xl'><Link className='h-full font-semibold justify-center flex items-center' to="/registration">Login</Link></button>
                            </div>
                        </div>
                    </div>
